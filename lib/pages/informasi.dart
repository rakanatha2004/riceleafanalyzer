        ...
        body: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              _menuItem(
                context,
                assetIcon: 'assets/icon/icon_info.png',
              ...
              _menuItem(
                context,
                assetIcon: 'assets/icon/question.png',
              ...
              _menuItem(
                context,
                assetIcon: 'assets/icon/logout.png',
                title: 'Logout',
                isLogout: true,
                onTap: () {
  ...
  Widget _menuItem(
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Row(
          children: [
            // Use asset icon when available, otherwise fallback to material icon
            if (assetIcon != null)
              Image.asset(
                assetIcon,
                width: 24,
